...
- The Default / Larsson / Greedy pipeline builds the template from $H_0$ plus a graph-ideal extension for reading off the action matrix. The MatrixHi pipeline skips the graph-ideal extension entirely, saving $|B|$ rows.
