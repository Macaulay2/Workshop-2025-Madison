newPackage("ExteriorResolutions",
	...
	{Name => "Andrew Karsten",       Email => "akk0071@auburn.edu",          HomePage => "https://sites.google.com/view/andrewkarsten/home" },
...
Node
   ...
   Description
	   ...
	   C == priddyComplex(vars E, Concentration => (-5,0))
       Text
...
Node
   ...
   Headline
       compute a Priddy differential of a Priddy complex
   Usage
       priddyDifferential(i, m)
   Inputs
       i:ZZ
       m:Matrix
   Outputs
   ...
   Description
       Text
	   Below we compute the $-3$rd differential of the @TO2(priddyComplex, "Priddy complex")@ generated by $e_0, e_0e_1\in\Lambda_k[e_0,e_1]$.
       Example
	   E = QQ[e_0,e_1, SkewCommutative=>true]
	   m = matrix{{e_0, e_0*e_1}}
