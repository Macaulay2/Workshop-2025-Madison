doc ///
    ...
    Description
        Text
            ...
            The box product makes $\text{Mack}_{C_p}$ into a symmetric monoidal category, which is {\em closed symmetric monoidal} due to the @TO2((Hom,CpMackeyFunctor,CpMackeyFunctor),"internal hom")@.
